...
from backend.models.all_models import User, UserRole, Event, Task, TaskStatus, TaskSubmission
from backend.schemas.schemas import EventCreate, EventUpdate, EventOut, TaskOut
from backend.services.pdf_report_service import generate_micro_report_html, generate_merged_report_html
from backend.services.notification_service import log_audit
from backend.routers.tasks import build_task_out
...
from backend.core.deps import get_current_user, get_current_user_optional, require_role
